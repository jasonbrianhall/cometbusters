...
const char **get_opening_crawl_for_language(int language) {
    switch(language) {
        ...
        case WLANG_CHINESE: return OPENING_CRAWL_LINES_SC;
...
int get_num_crawl_lines_for_language(int language) {
    switch(language) {
        ...
        case WLANG_CHINESE: return NUM_CRAWL_LINES_SC;
...
const char **get_victory_scroll_for_language(int language) {
    switch(language) {
        ...
        case WLANG_CHINESE: return VICTORY_SCROLL_LINES_SC;
...
int get_num_victory_lines_for_language(int language) {
    switch(language) {
        ...
        case WLANG_CHINESE: return NUM_VICTORY_LINES_SC;
